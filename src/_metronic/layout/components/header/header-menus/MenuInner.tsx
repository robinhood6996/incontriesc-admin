...
export function MenuInner() {
  ...
  return (
    <>
      ...
      <MenuItem title='Escorts' to='/users' />
      <MenuInnerWithSub title='Settings' to='/' menuPlacement='bottom-start' menuTrigger='click'>
        ...
        <MenuInnerWithSub
          ...
          menuTrigger={`{default:'click', lg: 'hover'}`}
        >
          <MenuItem to='/crafted/account/overview' title='Country' hasBullet={true} />
          <MenuItem to='/crafted/account/settings' title='City' hasBullet={true} />
        </MenuInnerWithSub>
